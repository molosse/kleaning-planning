...
const ctaGradient = `linear-gradient(135deg, ${DS_LOGIN.darkNavy} 0%, #1a2d47 50%, #2a4a6f 100%)`;
  ...
  <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" style={{ position: "absolute", inset: 0, opacity: 0.08 }}>
    <defs>
      <pattern id="zellige" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
        ...
        <polygon
          points="40,4 46,28 68,16 56,36 76,40 56,44 68,64 46,52 40,76 34,52 12,64 24,44 4,40 24,36 12,16 34,28"
          fill="none"
          stroke={DS_LOGIN.gold}
          strokeWidth="1.2"
        />
        <polygon
          points="40,14 44,28 56,22 50,34 62,40 50,46 56,58 44,52 40,66 36,52 24,58 30,46 18,40 30,34 24,22 36,28"
          fill="none"
          stroke={DS_LOGIN.gold}
          strokeWidth="0.6"
        />
          ...
          <form onSubmit={submit}>
              ...
              <div style={{ position: "relative" }}>
                <svg
                  ...
                  style={{
                    ...
                    color: focusUser ? DS_LOGIN.gold : "#94a3b8",
              ...
              <div style={{ position: "relative" }}>
                <svg
                  ...
                  style={{
                    ...
                    top: "50%",
                    transform: "translateY(-50%)",
                    color: focusPass ? DS_LOGIN.gold : "#94a3b8",
                    transition: "color .15s",
                  }}
                >
            ...
            <button
              ...
              style={{
                width: "100%",
                padding: "15px",
                background: loading ? "#94a3b8" : ctaGradient,
                color: "white",
                border: `2px solid ${loading ? "transparent" : DS_LOGIN.gold}`,
                borderRadius: 14,
                fontSize: 15,
                fontWeight: 600,
